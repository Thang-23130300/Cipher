...
<div class="page-container home-page">
    ...
    <section class="home-quick-panels" aria-label="Lối tắt danh mục sản phẩm">
        <a class="home-quick-panel"
           href="${pageContext.request.contextPath}/products?panel=vi-que-binh-dinh">
            <span class="home-quick-panel__icon" aria-hidden="true">
        ...
        <a class="home-quick-panel"
           href="${pageContext.request.contextPath}/products?panel=qua-tu-bien">
            <span class="home-quick-panel__icon" aria-hidden="true">
                <i class="fa-solid fa-fish"></i>
            </span>
            <span class="home-quick-panel__title">Quà Từ Biển</span>
            <span class="home-quick-panel__subtitle">Hải vị khó quên mang về</span>
        </a>

        <a class="home-quick-panel"
           href="${pageContext.request.contextPath}/products?panel=huong-men-dat-vo">
            <span class="home-quick-panel__icon" aria-hidden="true">
        ...
        <a class="home-quick-panel"
           href="${pageContext.request.contextPath}/products?panel=net-viet-lam-qua">
            <span class="home-quick-panel__icon" aria-hidden="true">
