...
<div class="page-container home-page">
    ...
    <c:forEach var="section"
               items="${data.topCategorySections}">

        <section
                id="Loai${section.category.id}"
                class="product-section home-section">
    ...
    <section
            id="extension"
            class="product-section home-section home-category-strip">
    ...
    <section class="section related-products home-section">
        ...
        <div class="related-grid product-list">
            ...
            <c:forEach var="p"
                       items="${data.topRatedProductCards}">
